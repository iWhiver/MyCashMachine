<div class="container" id="page">
    ...
    <g:form name="lifeCircle" controller="lifeCircle" action="index" class="form">
        <div class="form-group">
            ...
            <g:textArea name="Output" class="form-control" rows="20" readonly="true" id="output">${output}</g:textArea>
        </div>
        ...
        <g:actionSubmit value="Clean" action="clean" class="btn btn-secondary"/>
        <g:actionSubmit value="Drop DB" action="drop" class="btn btn-secondary"/>
    </g:form>

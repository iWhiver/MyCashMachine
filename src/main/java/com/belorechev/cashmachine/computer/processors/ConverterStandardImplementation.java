...
public class ConverterStandardImplementation implements Converter {

    @Override
    public String convertSetOfCashToString(Set<Cash> cashSet, String lineSeparator, boolean useCurrency, boolean useValue, boolean useAmountOfNotes) {
